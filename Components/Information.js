...
const Information = () => {
    return (
        <section className="text-gray-600 body-font m-14 mx-auto">
            <div className="container rounded-2xl mx-auto w-80 lg:w-3/4 flex px-5 py-8 bg-[#CAE4FF] md:flex-row flex-col items-center">
             ...
             <div className="lg:mt-6 mt-6 container rounded-2xl w-80 mx-auto lg:w-3/4 flex px-5 py-15 bg-[#CAE4FF] md:flex-row flex-col items-center">
                <div className="lg:max-w-lg lg:w-1/4 md:w-1/2 w-5/6 mb-10 md:mb-0">
