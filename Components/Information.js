...
const Information = () => {
    return (
        <section className="text-gray-600 body-font m-14 mx-auto">
            <div className="container rounded-2xl mx-auto lg:w-3/4 flex px-5 py-8 bg-[#CAE4FF] md:flex-row flex-col items-center">
                ...
                <div className="lg:flex-grow md:w-1/2 lg:pl-10 md:pl-16 flex flex-col md:items-start md:justify-center md:text-left items-center text-center">
                    ...
                    <p className="mb-8 text-black xl:text-xl">We are a leading business in the field of import and export, based in India. Our motto is to connect with lives of people by providing products of their need to enhance their lifestyle and creating our globe in structure of one big family in its true sense.We also export other products of any category, it will be a pleasure if you contact us!</p>
                </div>
            </div>
